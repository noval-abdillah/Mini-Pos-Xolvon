...
export default function POSPage() {
  ...
  return (
    <div className="mx-auto max-w-[1280px] px-8 py-8 animate-fade-in">
      {checkoutSuccessData ? (
        <div className="mx-auto max-w-md rounded-xl border border-[#E5E7EB] bg-white p-6 shadow-sm text-center">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-green-50 text-[#22C55E]">
          ...
          <div className="mt-6 border-t border-[#E5E7EB] pt-4 text-left space-y-3 text-xs">
          ...
          <button
            ...
            className="mt-6 w-full h-10 rounded-lg bg-[#2563EB] text-white text-sm font-medium hover:bg-[#1D4ED8] transition-colors duration-150"
          >
            Transaksi Baru
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            {isLoading ? (
              ...
              <div className="flex h-64 items-center justify-center rounded-xl border border-dashed border-[#E5E7EB] bg-white p-6">
                      ...
                      <div className="p-5 flex flex-col justify-between flex-1">
                        ...
                        <div className="mt-6 flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="h-8 px-4 rounded-lg bg-[#2563EB] text-xs font-medium text-white hover:bg-[#1D4ED8] disabled:opacity-40 disabled:cursor-not-allowed transition-colors duration-150"
                          >
                            Tambah
                          </button>
                        </div>
          ...
          <div className="rounded-xl border border-[#E5E7EB] bg-white p-6 shadow-sm flex flex-col justify-between h-[calc(100vh-140px)] sticky top-24">
            ...
            <div className="border-t border-[#E5E7EB] pt-5 mt-4 bg-white">
              ...
              <button
                ...
                className="mt-5 w-full h-11 rounded-lg bg-[#2563EB] text-white font-semibold text-sm hover:bg-[#1D4ED8] disabled:opacity-40 disabled:cursor-not-allowed transition-colors duration-150 flex items-center justify-center gap-2 shadow-sm"
              >
